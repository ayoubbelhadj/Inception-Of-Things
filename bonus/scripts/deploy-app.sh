...
APP_NAME="playground-app-gitlab"
...
echo -e "  1. Check the app:"
echo -e "     ${YELLOW}kubectl get pods -n ${DEV_NAMESPACE}${NC}"
echo ""
...
echo ""
echo -e "  3. Change version (v1 → v2):"
echo -e "     Edit ${GREEN}dev/deployment.yaml${NC} in GitLab UI and commit."
echo -e "     Watch: ${YELLOW}kubectl get application ${APP_NAME} -n argocd -w${NC}"
echo ""
